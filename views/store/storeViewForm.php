...
<head>
    ...
    <title>Inqulino de la Tienda</title>
</head>
<body>
    <div class="container">
      <header>
        <section id="user">
          Hola, Inquilino de la Tienda<?php  ?><br>
            ...
            <table>
              <tr>
                ...
                <?php
                  ...
                  //NAMED PLACEHOLDER
                  $query = $db->connect()->prepare('SELECT * FROM rentshop WHERE 
            ...
            <table>
              <tr>
                ...
                <?php
                  ...
                  //FECH ALL DATA FROM TALBE RENTGARAGE
                  //NAMED PLACEHOLDER
                  $query = $db->connect()->prepare('SELECT * FROM serviceshop WHERE 
                  paymentCondition_db = :paymentCondition');
                  //BINDPARAM
                  $paymentCondition = "NO Pagado";
                  $query->bindParam(':paymentCondition', $paymentCondition);
            ...
            <table>
                <tr>
                  ...
                  <?php
                    ...
                    //FECH ALL DATA FROM TALBE RENTGARAGE
                    //NAMED PLACEHOLDER
                    $query = $db->connect()->prepare('SELECT * FROM rentshop');
                    //BINDPARAM
                    $paymentCondition = "NO Pagado";
                    $query->bindParam(':paymentCondition', $paymentCondition);
                    $query->execute();
              ...
              <table>
                <tr>
                  ...
                  <?php
                    ...
                    //FECH ALL DATA FROM TALBE RENTGARAGE
                    //NAMED PLACEHOLDER
                    $query = $db->connect()->prepare('SELECT * FROM serviceshop');
                    //BINDPARAM
                    $paymentCondition = "NO Pagado";
                    $query->bindParam(':paymentCondition', $paymentCondition);
                    $query->execute();
