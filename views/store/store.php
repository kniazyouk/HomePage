    ...
    <div class="container">
      ...
      <div id="content">
        ...
        <div id="grid-container-admin">
          <div class="dropdown">
            <button class="dropbtn">Store Leasing</button>
            <div class="dropdown-content">
            <a href="storeRentForm.php">///Rent///</a>
            <a href="storeRentModDBForm.php">Modify DB</a>
            </div>
          </div>
          <div class="dropdown">
            <button class="dropbtn">Store Services</button>
            <div class="dropdown-content">
            <a href="storeServicesForm.php">///Services///</a>
            <a href="storeServModDBForm.php">Modify DB</a>
            </div>
          </div>

          <div id="grid-viewOption">
            <a href="storeViewForm.php">Store View</a>
          </div>
        </div>
        ...
        <div id="grid-container-admin">
          <div id="grid-paymentOption">
            <a href="storeRentForm.php">Store Rent</a>
          </div>
          <div id="grid-paymentOption">
            <a href="storeServicesForm.php">Store Services</a>
          </div>
          <div id="grid-viewOption">
            <a href="storeViewForm.php">Store View</a>
          </div>
