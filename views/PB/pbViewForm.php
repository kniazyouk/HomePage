            ...
            <table>
              <tr>
                ...
                <?php
                  ...
                  //NAMED PLACEHOLDER
                  $query = $db->connect()->prepare('SELECT * FROM rentpb WHERE 
            ...
            <table>
              <tr>
                ...
                <?php
                  ...
                  //FECH ALL DATA FROM TALBE RENTGARAGE
                  //NAMED PLACEHOLDER
                  $query = $db->connect()->prepare('SELECT * FROM servicepb WHERE 
                  paymentCondition_db = :paymentCondition');
                  //BINDPARAM
                  $paymentCondition = "NO Pagado";
                  $query->bindParam(':paymentCondition', $paymentCondition);
            ...
            <table>
                <tr>
                  ...
                  <?php
                    ...
                    //FECH ALL DATA FROM TALBE RENTGARAGE
                    //NAMED PLACEHOLDER
                    $query = $db->connect()->prepare('SELECT * FROM rentpb');
                    //BINDPARAM
                    $paymentCondition = "NO Pagado";
                    $query->bindParam(':paymentCondition', $paymentCondition);
                    $query->execute();
              ...
              <table>
                <tr>
                  ...
                  <?php
                    ...
                    //FECH ALL DATA FROM TALBE RENTGARAGE
                    //NAMED PLACEHOLDER
                    $query = $db->connect()->prepare('SELECT * FROM servicepb ');
                    //BINDPARAM
                    $paymentCondition = "NO Pagado";
                    $query->bindParam(':paymentCondition', $paymentCondition);
                    $query->execute();
