...
<head>
    ...
    <title>PB Services Register Form</title>
</head>
<body>
    <div class="container">
      <header>
        <section id="user">
          ...
          <h1>PB Services Register Form</h1>
        </section>
      </header>
...
if(isset($_POST['registServ'])){
  ...
  $insertData = "INSERT INTO servicepb ( `servDate_db`, `balanceLightAmount_db`,`balanceWaterAmount_db`, `paymentCondition_db`, `notes_db`) values ('$fechaServ','$balanceLuz','$balanceAgua','$estado', '$nota')";
