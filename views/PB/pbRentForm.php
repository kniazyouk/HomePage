...
<head>
    ...
    <title>PB Registration Payment Form</title>
</head>
<body>
    <div class="container">
      <header>
        <section id="user">
          ...
          <a id="back" href="http://localhost:60/HomePage/views/PB/pb.php">Back</a>
          <!-- <a id="back" href="https://4rent1118.000webhostapp.com/views/PB/pb.php">Back</a>  -->
          <h1>PB Registration Payment Form</h1>
        </section>
      </header>
...
if(isset($_POST['register'])){
  ...
  $insertData = "INSERT INTO rentpb ( `rentDate_db`, `paidAmount_db`, `balanceAmount_db`, `wayToPay_db`, `paymentCondition_db`, `notes_db`) values ('$fechaRent','$monto','$saldo','$formaPago','$estado', '$nota')";
