...
<head>
    ...
    <title>Garage Rent Payment Form</title>
</head>
<body>
    <div class="container">
      <header>
        <section id="user">
          ...
          <h1>Garage Rent Payment Form</h1>
        </section>
      </header>
...
if(isset($_POST['register'])){
  ...
  $balance = $_POST['balanceForm'];
  $formaPago = $_POST['wayToPayForm'];
  $estado = $_POST['paymentConditionForm'];
  $nota = $_POST['textAreaForm'];
 

  $insertData = "INSERT INTO rentgarage ( `rentDate_db`, `paidAmount_db`, `balanceAmount_db`, `wayToPay_db`, `paymentCondition_db`, `notes_db`) values ('$fechaRent','$monto','$balance','$formaPago','$estado', '$nota')";
